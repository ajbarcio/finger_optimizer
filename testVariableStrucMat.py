...
print(f"Ambrose overall valid at THETA={[0]*dimensionalAmbrose.numJoints}? {dimensionalAmbrose.controllability([0]*dimensionalAmbrose.numJoints)}")
print(dimensionalAmbrose([0]*dimensionalAmbrose.numJoints))
print(f"rank valid? {dimensionalAmbrose.controllability.rankCriterion}")
print(f"null space valid? {dimensionalAmbrose.controllability.nullSpaceCriterion}, with condition {dimensionalAmbrose.controllability.biasForceCondition}")
print(f"bias force direction: {dimensionalAmbrose.controllability.biasForceSpace.T}")
print(f"Ambrose overall valid at THETA={[np.pi/2]*dimensionalAmbrose.numJoints}? {dimensionalAmbrose.controllability([np.pi/2]*dimensionalAmbrose.numJoints)}")
print(dimensionalAmbrose([np.pi/2]*dimensionalAmbrose.numJoints))
print(f"rank valid? {dimensionalAmbrose.controllability.rankCriterion}")
print(f"null space valid? {dimensionalAmbrose.controllability.nullSpaceCriterion}, with condition {dimensionalAmbrose.controllability.biasForceCondition}")
print(f"bias force direction: {dimensionalAmbrose.controllability.biasForceSpace.T}")
...
dimensionalAmbrose.plotCapability([0]*dimensionalAmbrose.numJoints)
